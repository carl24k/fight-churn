...
#../../venv/bin/python churnsim.py --model $SCHEMA  --n_parallel 5 --init_customers 2000 --start_date 2022-01-01 --end_date 2024-01-01  --growth_rate 0.04 --acausal_churn 0.02  --min_age 0 --max_age 10 --age_satisfy 3 --weekday_scale 0.1 --weekend_scale -0.25
#cd $HOME/$CHURN_ROOT/fight-churn/fightchurn/
#
## churn rate
