...
select account_id, metric_date, %new_metric_id as metric_name_id, avg(discount) as metric_value
...
INSERT into metric_name values (%new_metric_id,concat('discount'))
ON CONFLICT DO NOTHING;