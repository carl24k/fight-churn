...
select account_id, metric_date::date, %new_metric_id as metric_name_id, sum(%field2sum) as metric_value
...
INSERT into metric_name values (%new_metric_id,concat('sum_%event2measure_value'))
ON CONFLICT DO NOTHING;
