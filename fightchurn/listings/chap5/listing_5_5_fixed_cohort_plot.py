...
def fixed_cohort_plot(data_set_path, metric_to_plot='',bins=[]):
    ...
    groups = pd.cut(churn_data[metric_to_plot], bins=bins, right=True, include_lowest=True, duplicates='drop')
